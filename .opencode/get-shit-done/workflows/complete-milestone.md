...
```bash
node "C:/Users/ErikBerg/source/kanata-editor/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/ErikBerg/source/kanata-editor/.opencode/get-shit-done/templates/retrospective.md`.
