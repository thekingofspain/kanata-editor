...
```
Task(
  prompt="Read C:/Users/ErikBerg/source/kanata-editor/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/ErikBerg/source/kanata-editor/.opencode/get-shit-done/templates/VALIDATION.md`
