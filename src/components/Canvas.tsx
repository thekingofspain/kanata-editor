...
export const Canvas: React.FC = () => {
  ...
  const { layout, canvas, grid, selection, updateKey, selectKey, selectKeys, clearSelection, setCanvasPan, setCanvasZoom, setLastMousePos, setCanvasSize, duplicateSelection } = useEditorStore();
